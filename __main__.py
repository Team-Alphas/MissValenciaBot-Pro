...
from MissValencia import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, telethn
from MissValencia.modules import ALL_MODULES
from MissValencia.modules.helper_funcs.chat_status import is_user_admin
from MissValencia.modules.helper_funcs.misc import paginate_modules
from MissValencia.modules.connection import connected
from MissValencia.modules.connection import connect_button


PM_START_TEXT = """
_Heya_ *{}*
_I'm_ *{}*\n_A powerful Telegram Group Management Bot...I'm specialized In Managing Group With My Advance Features... Feel Free To Add me To Your Group And Make Me Admin For Good Performance !!
...
HELP_STRINGS = """
Heya! I'm *{}*.
I'm a fastest and safest group management bot with a few fun extras.. If you have any Queries on how to use me, Make Sure to Report at @MissValenciaSupport
...
if START_IMG is None:
    img = "https://telegra.ph/file/e9c05043cf8a169c18490.jpg"
else:
  img = START_IMG    
    
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("MissValencia.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="?Help",callback_data="help_back"),InlineKeyboardButton(text="👑Creator👑",url="https://t.me/IAmRohanX")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/CrazyKing023")]]))
        return
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("MissValencia running...")
