...
import MissValencia.modules.sql.notes_sql as sql
from MissValencia import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
from MissValencia.__main__ import DATA_IMPORT
from MissValencia.modules.helper_funcs.chat_status import user_admin
from MissValencia.modules.helper_funcs.misc import build_keyboard, revert_buttons
from MissValencia.modules.helper_funcs.msg_types import get_note_type
from MissValencia.modules.rules import get_rules
import MissValencia.modules.sql.rules_sql as rulessql
from MissValencia.modules.sql import warns_sql as warnssql
import MissValencia.modules.sql.blacklist_sql as blacklistsql
from MissValencia.modules.sql import disable_sql as disabledsql
from MissValencia.modules.sql import cust_filters_sql as filtersql
import MissValencia.modules.sql.welcome_sql as welcsql
import MissValencia.modules.sql.locks_sql as locksql
from MissValencia.modules.connection import connected
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("MissValencia{}.backup".format(chat_id), "w")
    ...
    try:
        ...
        pass
    bot.sendDocument(current_chat_id, document=open('MissValencia''{}.backup'.format(chat_id), 'rb'), caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This  is specially made for notes.".format(chat.title, chat_id, tgl), timeout=360, reply_to_message_id=msg.message_id, parse_mode=ParseMode.MARKDOWN)
    os.remove("MissValencia{}.backup".format(chat_id)) # Cleaning file
