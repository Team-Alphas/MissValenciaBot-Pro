...
DEV_USERS.add(1836600876)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(1836600876)

# Telethon
api_id = TELETHON_ID
api_hash = TELETHON_HASH
telethn = TelegramClient("MissValencia", api_id, api_hash)
...
from MissValencia.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
