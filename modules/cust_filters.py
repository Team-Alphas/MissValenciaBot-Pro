...
from MissValencia import dispatcher, LOGGER
...
from MissValencia.modules.helper_funcs.extraction import extract_text
from MissValencia.modules.helper_funcs.filters import CustomFilters
from MissValencia.modules.helper_funcs.misc import build_keyboard
from MissValencia.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from MissValencia.modules.sql import cust_filters_sql as sql
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @CrazyKing023 for help.")
                        ...
                        message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in "
                                           "@CrazyKing023 if you can't figure out why!")
